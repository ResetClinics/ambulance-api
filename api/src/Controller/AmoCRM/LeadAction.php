...
use App\Command\Lead\Update\Command;
use App\Command\Lead\Update\Handler;
...
class LeadAction extends AbstractController
{
    ...
    public function __invoke(Request $request): JsonResponse
    {
      ...
      //      /** @var Lead[] $leads */
      //      $leads = $this->serializer->denormalize(
      //          $data['leads']['update'],
      //          Lead::class . '[]'
      //      );

      //      foreach ($leads as $lead) {
      //          if ($lead->pipelineId === '4018768') {

      //              $command = new Command($lead);
